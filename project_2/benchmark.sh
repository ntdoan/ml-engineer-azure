...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 100 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_BY_PRIMARY_KEY_OF_ENDPOINT' http://94082c13-9122-4f93-9536-d7317136dbb1.southcentralus.azurecontainer.io/score
